<x-app-layout>
    <div class="font-sans antialiased min-h-screen bg-gray-200 text-black">
        <div class="flex justify-center mb-10 pt-10">
            <form method="post" action="{{ route('category.update', $category->id) }}" class="w-96">
                @csrf
                @method("put")
                ...
                <div class="flex-col">
                    <div class="mb-3 w-96">
                        ...
                        <x-input class="text-black w-96" type="text" name="categorie" id="categorie" value="{{ $category->categorie }}"></x-input>
                    </div>
                    <input
